...
def main():
    ...
    m1, b1, m2, b2 = (2.104, 14.2, 2.1,13.2) # from Joost hart
    p0_dict = {
    "M3":{"m1": m1,
    "b1": b1,
    "m2": m2,
    ...
    m1_bounds = (0.1*m1, 10*m1)
    m2_bounds = (0.1*m2, 10*m2)
    b1_bounds = (0.1*b1, 10*b1)
    b2_bounds = (0.1*b2, 10*b2)
    ...
    "M3": {
    "m1": {"type": "gaussian", "kwargs": {"mu":m1, "sigma": 0.3*m1}},
    "b1": {"type": "uniform", "kwargs": {"low":0.3*b1, "high": 6*b1}},
