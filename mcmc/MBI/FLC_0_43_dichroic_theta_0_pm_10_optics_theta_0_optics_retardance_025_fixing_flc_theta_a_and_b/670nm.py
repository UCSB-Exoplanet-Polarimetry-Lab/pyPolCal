...
# Define ideal system confFLC_0_43_dichroic_theta_0_pm_10_optics_theta_0_optics_retardance_025_adding_flc_theta_a_and_b_to_read_csviguration (this should reflect the setup of your optical train)
system_dict = {
    "components": {
        "wollaston": {
