...
output_h5_file = "/home/rebeccaz/Github/vampires_calibration/mcmc/results/" + str(filter_wavelength) + "nm.h5"

# Load dataset (replace with your file path)
interleaved_values, interleaved_stds, configuration_list = \
    inst.read_csv(csv_path, obs_mode="MBI", obs_filter=filter_wavelength)
