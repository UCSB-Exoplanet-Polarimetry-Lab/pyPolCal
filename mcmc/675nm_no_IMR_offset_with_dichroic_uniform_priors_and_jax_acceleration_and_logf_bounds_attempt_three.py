...
with open(str(filter_wavelength) + "nm.txt", "r") as f:
    p0 = json.load(f)
...
# Saving parameters
output_h5_file = "675nm_no_IMR_offset_with_dichroic_uniform_priors_and_jax_acceleration_and_logf_bounds_attempt_three.h5"
nsteps = 40000
